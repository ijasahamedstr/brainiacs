...
import WebsiteSlider from '../models/WebsiteSlider.models.js';  // Corrected import
...
export const WebsiteSliderSingleDetails = async (req, res) => {
    try {
...
export const WebsiteSliderUpdate  = async (req, res) => {
